...
<body class="onepage" data-bs-spy="scroll" data-bs-target=".navbar">
    <div class="content-wrapper">
                ...
                <div class="container flex-lg-row flex-nowrap align-items-center">
                    ...
                    <div class="navbar-collapse offcanvas-nav">
                        <div class="offcanvas-header d-lg-none d-xl-none">
                            <a href="index.html"><img src="<?php echo base_url(); ?>assets/img/logo/solveathon_logo.png"
        ...
        <section class="wrapper image-wrapper bg-image bg-overlay bg-overlay-400 text-white"
            ...
            <div class="container pt-17 pb-15 pt-md-10 pb-md-10 text-center">
                <div class="row">
                    <div class="col-lg-8 mx-auto">
                        <h1 class="display-1 mb-3 text-white"><?=$page_title;?></h1>
                        <!-- /nav -->
                    </div>
                    <!-- /column -->
                </div>
