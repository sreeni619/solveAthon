                    ...
                    <div class="card-body">
        			   <?php echo form_open_multipart($action, 'class="user"'); ?>
        			    ...
        			    <div class="form-group mb-2">
                            ...
                            <input type="text" name="member_name" id="member_name" class="form-control" value="<?php echo (set_value('member_name'))?set_value('member_name'):$details->member_name;?>">
            		        <span class="text-danger"><?php echo form_error('member_name'); ?></span>
                        </div>
                        
                        <div class="form-group mb-2">
                            <label class="h6">Mobile</label>
                            <input type="text" name="member_mobile" id="member_mobile" class="form-control" value="<?php echo (set_value('member_mobile'))?set_value('member_mobile'):$details->member_mobile;?>">
            		        <span class="text-danger"><?php echo form_error('member_mobile'); ?></span>
                        </div>
                        
                        <div class="form-group mb-2">
                            <label class="h6">Email</label>
                            <input type="text" name="member_email" id="member_email" class="form-control" value="<?php echo (set_value('member_email'))?set_value('member_email'):$details->member_email;?>">
