            ...
            <div class="scroll">
                <ul class="list-unstyled">
                    <li class=<?php echo ($menu_active == 'dashboard') ? 'active' :''; ?>>
                        <?php echo anchor('evaluator/dashboard','<img src="'.base_url().'assets/img/icons/dashboard.png" class="sidebar-icon"/> <span>Dashboard</span>',''); ?>
                    </li>
                    <li class=<?php echo ($menu_active == 'change_password') ? 'active' :''; ?>>
                        <?php echo anchor('evaluator/students','<img src="'.base_url().'assets/img/icons/students.png" class="sidebar-icon"/> <span>Change Password</span>',''); ?>
                    </li> 
                    <li class=<?php echo ($menu_active == 'logout') ? 'active' :''; ?>>
                        <?php echo anchor('evaluator/logout','<img src="'.base_url().'assets/img/icons/logout.png" class="sidebar-icon"/> Logout',''); ?>
                    </li>
