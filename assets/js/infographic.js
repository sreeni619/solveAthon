...
//     $.ajax({
// 		url : 'welcome/categoriesCount',
// 		type : "GET",
// 		success : function(data) {
// 			console.log(data);
// 			categories_count = data;
// // 			var len = data.length;
// 		},
// 		error : function(data) {
// 			console.log(data);
...
// 	});
 ...
 function colorChange(elm) {
        elm.addEventListener('mouseover', function(e) {
            elm.style.fill = '#f90';
            $("#infoname").text(elm.attributes["title"].value);
        });
        elm.addEventListener('mouseout', function(e) {
            elm.style.stroke = "rgb(206, 240, 252)"; 
            elm.style.fill = "rgb(243, 253, 254)";
        });
    }
 ...
 function indiaMap() {
  if (document.getElementById("india-map")) {
      ...
      var path = document.getElementById("india-map").querySelectorAll("path");
    ...
    //   console.log(path);
      ...
      for (var i = 0; i < path.length; ++i) {
            var state = path[i];
            colorChange(path[i]);
            // var stateName = state.getAttribute('title');
            // console.log(path[i].attributes["title"].value);
            // $("#infoname").text(path[i].id);
  ...
  d3.json("assets/data/districts.json", function(json) {
    all_districts
    .data(json.features)
    .enter().append("path")
  ...
  d3.json("assets/data/data.json", function(json) {
    all_data = json;
    initialize();
  });
...
//   d3.json("assets/data/govt_vs_non.json", function(json) {
//     chart_data = json;
//   });


//   d3.json("assets/data/girl_vs_boy.json", function(json) {
//     girl_vs_boy = json;
//   });

//   d3.json("assets/data/math.json", function(json) {
//     math = json;
//   });

//   d3.json("assets/data/english.json", function(json) {
//     english = json;
//   });

//   d3.json("assets/data/kannada.json", function(json) {
//     kannada = json;
//   });

  d3.json("assets/data/moi.json", function(json) {
    moi = json;
  });
...
//     d3.xml("assets/img/girl.svg", "image/svg+xml", function(xml) {
//       imported_node = document.importNode(xml.documentElement, true);
//       d3.selectAll(".bg").each(append_all);
//     });

//     d3.xml("assets/img/boy.svg", "image/svg+xml", function(xml) {
//       imported_node = document.importNode(xml.documentElement, true);
//       d3.selectAll(".bg").each(append_all);
//     });
